...
namespace GeekText
{
    ...
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            dbSavedInfo = user.setUserCredentials(FirstNameTextBox.Text.Trim(), LastNameTextBox.Text.Trim(), 
                NickNameTextBox.Text.Trim(), UserNameTextBox.Text.Trim(), PasswordTextBox1.Text.Trim(), 
                EmailTextBox1.Text.Trim(), ConfigurationManager.ConnectionStrings["GeekTextConnection"].ConnectionString);
